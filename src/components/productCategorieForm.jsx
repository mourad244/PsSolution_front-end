...
import { getProductCategorie, saveProductCategorie } from '../services/productCategorieService';
...
class ProductCategorieForm extends Form {
	...
	async populateProducts() {
		try {
			...
			const { data: productCategorie } = await getProductCategorie(productCategorieId);
	...
	render() {
		...
		return (
			<div className={'card textcenter mt-3 ' + (this.props.formDisplay || productCategorieId ? '' : 'add-item')}>
