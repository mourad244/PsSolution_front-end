...
class ServiceForm extends Form {
	...
	schema = {
		...
		caracteristiques: Joi.label('Caracteristiques'),
		images: Joi.label('images'),
		accessoires: Joi.label('accessoires'),
	...
	render() {
		...
		return (
			<div className={'card textcenter mt-3 ' + (this.props.formDisplay || serviceId ? '' : 'add-item')}>
				...
				<div className="card-body">
					<form id="aptForm" noValidate onSubmit={this.handleSubmit}>
						...
						{this.state.data.accessoires.length !== 0 && this.renderImage('accessoires', 'Accessoire')}
						{this.renderUpload('accessoire', 'upload accessoire')}
						{this.renderSelect('categorie', 'Categorie de produit', this.state.categories)}
