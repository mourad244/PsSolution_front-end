...
import { getProductType, saveProductType } from '../services/productTypeService';
...
class ProductTypeForm extends Form {
	...
	render() {
		...
		return (
			<div className={'card textcenter mt-3 ' + (this.props.formDisplay || productTypeId ? '' : 'add-item')}>
